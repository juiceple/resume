  ...
  return (
    <div className="flex-1 w-full flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center mt-16">
        <section className="w-full h-[900px] text-center">
          <div className='page-bg p-24'>
            ...
            <div className="flex justify-center space-x-4 mb-12">
              <HomeButton variant="gradient" text="출시 알람 받기" url="https://docs.google.com/forms/d/1rbWJhRYZ6rzMH4YhcphhQPFq7LwL7PT8IPlUVHNjkps/prefill" size="medium" />
            </div>
            <div className="relative w-full max-w-[700px] mx-auto">
              <div className="relative w-[600px] aspect-video mx-auto z-10">
                <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-2xl p-4"
                  style={{
                    borderRadius: '17.007px',
                    border: '1.417px solid #333',
              ...
              <div className="w-full mt-[-20px] z-20">
        ...
        <section className="w-full h-[900px] flex flex-col gap-6 py-12 px-24">
          ...
          <HomeButton variant="gradient" text="출시 알람 받기" url="https://docs.google.com/forms/d/1rbWJhRYZ6rzMH4YhcphhQPFq7LwL7PT8IPlUVHNjkps/prefill" size="small" />
        ...
        <section className="w-full flex flex-col px-24">
          <div className="w-full py-12 text-start">
            ...
            <div className='flex justify-end'>
              <button className="bg-blue-500 text-white px-6 py-2 rounded">지금 바로 시작하기</button>
            </div>
          </div>
          {/* Statistics Section */}
        ...
        <SlideUpSection className="w-full h-[800px] flex flex-col w-full justify-center items-center bg-white py-6 text-center">
          ...
          <div className="flex flex-col items-center max-w-md w-full mx-auto shadow-md start-card p-[60px] gap-6">
