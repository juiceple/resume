...
interface FullScreenLoaderProps {
  message: string;
  isVisible: boolean; // Control visibility of the loader
}

const FullScreenLoader: React.FC<FullScreenLoaderProps> = ({ message, isVisible }) => {
  if (!isVisible) return null; // Return null to hide the component when isVisible is false
