    ...
    <>
      ...
      <div className="grid grid-cols-7 gap-6">
        <button
          ...
          className="w-full text-left focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:z-10"
          disabled={loading}
        >
          <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col items-center justify-center">
        ...
        {resumes.map((resume) => (
          <div key={resume.id} className="relative group">
            <div className="w-full h-full transition-all duration-300 ease-in-out transform group-hover:scale-105 group-hover:z-10">
              <button
                onClick={() => handleResumeClick(resume.id)}
                className="w-full h-full text-left focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-lg"
                disabled={loading}
              >
                <div className="bg-white text-center p-4 rounded-lg shadow-md group-hover:shadow-xl hover:bg-[#EDF4FF] transition-all duration-300 h-full">
                  <h3 className="font-semibold text-sm pr-6 mb-2 truncate">{resume.title}</h3>
              ...
              <div className="absolute top-3 right-2 transition-all duration-300 ease-in-out transform group-hover:scale-105">
                <Popover>
