...
const PdfDownloadModal: React.FC<PdfDownloadModalProps> = ({ onDownload }) => {
    ...
    return (
        <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <AlertDialogTrigger className='h-[35px]'>
                <button
                    className="Resume-color-10 rounwhite rounded-full text-black flex shrink-0 items-center w-[120px] items-center justify-center gap-1 hover:bg-[#1759C4] h-full"
            ...
            <AlertDialogContent className="w-[476px] h-auto py-10 flex flex-col gap-6 items-center justify-center">
                ...
                <div className="flex gap-4 justify-center mt-4">
                    <AlertDialogCancel asChild className='bg-gray-300 hover:bg-gray-400 rounded-2xl'>
                        <button
                            className="w-28 h-12 bg-gray-200 text-white rounded-2xl text-lg"
                        >
                            취소
                        </button>
                    </AlertDialogCancel>
                    <AlertDialogAction asChild className='bg-blue-500 hover:bg-blue-600 rounded-2xl'>
                        <button
