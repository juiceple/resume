...
export function SpacingButtons({ docsId }: SpacingButtonsProps) {
  ...
  return (
    <div id="line-spacing" className="flex items-center bg-[#EDEDED] rounded-md">
      <button className="toolBarCompo" onClick={decreaseSpacing} aria-label="Decrease line spacing">
      ...
      <button className="toolBarCompo" onClick={increaseSpacing} aria-label="Increase line spacing">
